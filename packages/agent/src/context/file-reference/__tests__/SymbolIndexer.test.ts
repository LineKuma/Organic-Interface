      ...
      const file = createParsedFile({
        ...
        symbols: [
          ...
          },
          {
            ...
            line: 10, column: 1, endLine: 10, endColumn: 5,
            path: 'test.ts',
          },
        ],
      });
      ...
      const file = createParsedFile({
        ...
        symbols: [
          ...
          },
          {
            name: 'ClassB',
            kind: SymbolKind.CLASS,
            line: 10, column: 1, endLine: 10, endColumn: 7,
            path: 'test.ts',
          },
          {
            name: 'funcA',
            kind: SymbolKind.FUNCTION,
            line: 20, column: 1, endLine: 20, endColumn: 6,
            path: 'test.ts',
          },
        ],
      });
        ...
        symbols: [
          {
            name: 'UserService',
            kind: SymbolKind.CLASS,
            line: 1, column: 50, endLine: 1, endColumn: 61,
            path: 'service.ts',
          },
        ],
      });
  ...
  describe('getStats', () => {
    ...
    it('should return accurate stats', () => {
      const file1 = createParsedFile({
        path: 'file1.ts',
        symbols: [
          { name: 'a', kind: SymbolKind.FUNCTION, line: 1, column: 1, endLine: 1, endColumn: 2, path: 'file1.ts' },
          { name: 'b', kind: SymbolKind.CLASS, line: 2, column: 1, endLine: 2, endColumn: 2, path: 'file1.ts' },
        ],
      });
      ...
      const file2 = createParsedFile({
        path: 'file2.ts',
        symbols: [
          { name: 'c', kind: SymbolKind.VARIABLE, line: 1, column: 1, endLine: 1, endColumn: 2, path: 'file2.ts' },
        ],
      });
