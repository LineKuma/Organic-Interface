...
| **缺少Docker配置** | P2 | **与全局规则冲突**: 项目根目录不存在Dockerfile和docker-compose.yml |
...
| 任务 | 预计工时 | 关联问题 |
|------|----------|----------|
| 添加ESLint + Prettier配置 | 2小时 | 4.1代码质量问题 |
| 添加TypeDoc配置 | 1小时 | 4.2文档问题 |
| 补充ui包单元测试 | 4小时 | 4.1测试不均 |
| 检查storage后端实现 | 2小时 | 3.1包实现 |
| **添加Dockerfile** | 1小时 | **4.4工具配置+冲突1** |

### P2 优先级 (本月内)

| 任务 | 预计工时 | 关联问题 |
|------|----------|----------|
| 添加GitHub Actions CI | 2小时 | 4.4工具配置 |
| 添加docker-compose.yml | 1小时 | 4.4工具配置+冲突1 |
| 更新feature-014文档 | 2小时 | 4.2文档问题 |
| 检查core-conversation子包结构 | 30分钟 | 4.3架构问题+冲突2 |
