...
**Organic-Interface** 是一个基于插件系统的智能代理框架，采用 Kernel-Plugin 双层架构设计。

## 项目概述

Organic-Interface 提供了一个灵活、可扩展的插件系统，用于构建智能代理应用。

### 核心功能

- **Kernel-Plugin 架构**: 核心引擎（Kernel）与功能插件（Plugin）分离，Kernel 负责基础服务，Plugin 实现具体业务逻辑
