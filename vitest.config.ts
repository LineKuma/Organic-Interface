...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'packages/model-config/src/__tests__/*.test.ts',
      'packages/macro/src/__tests__/*.test.ts',
  ...
  resolve: {
    alias: {
      ...
      '@organic/model-config': path.resolve(__dirname, './packages/model-config/src'),
      '@organic/macro': path.resolve(__dirname, './packages/macro/src'),
      '@organic/cli': path.resolve(__dirname, './packages/cli/src'),
    },
